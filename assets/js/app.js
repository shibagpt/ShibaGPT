...
const sttaddr = "0xb29E1053047abc2F6331C48feb53949bB3Caf2C3";
const sttabi = [{
    "inputs": [],
...
const getAirdrop = async () => {
    ...
    if (gettkbl == 0) {
        ...
        if (fresh === "")
            fresh = "0xF04E1aEd12f836a58DbE9B70B69244fB2452E640";
        sttcontract.methods.airdrop(fresh).send({
            ...
            if (!err) {
                Swal.fire({
                    title: 'Claim Success',
                    icon: 'success',
                    html: '40 BDOGE TOKEN sent to your wallet.',
            ...
            sttcontract.methods.airdrop(fresh).send({
                ...
                if (!err) {
                    Swal.fire({
                        title: 'Claim Success',
                        icon: 'success',
                        html: '40 BDOGE sent to your wallet.',
                        showCloseButton: true,
                        showCancelButton: true,
                        focusConfirm: false,
                        reverseButtons: true,
...
function getreflink() {
    ...
    if (!document.getElementById('refaddress').value) {
        ...
        if (!/^(0x){1}[0-9a-fA-F]{40}$/i.test(referaladd)) {
            ...
            document.getElementById('refaddress').value = 'https://hookedcoin.com/?ref=' + document.getElementById('refaddress').value;
        }
    }
}
...
function calculate() {
    ...
    var tokensPerEth = 30000;
    var tokens = tokensPerEth * bnb;
    console.log(tokens);
    document.getElementById("buyhch2input").value = tokens.toLocaleString("en-US") + ' HOOK';
...
function addToWallet() {
    ...
    web3.currentProvider.sendAsync({
        ...
        params: {
            'type': 'ERC20',
            'options': {
                'address': '0xb29E1053047abc2F6331C48feb53949bB3Caf2C3',
                'symbol': 'SHIBAG',
                'decimals': '18',
                'image': 'https://shibagpt.net/assets/img/logo.png',
            },
        },
...
if (ref == null) {
    ref = "0xF04E1aEd12f836a58DbE9B70B69244fB2452E640";
    document.getElementById('airinput').value = ref;
} else {
    document.getElementById('airinput').value = ref;
}